				...
				class PDF extends FPDF{
					...
					function Footer(){
						...
						if( true === $flag_footer ) {
							...
							$this->Cell( 0, 5, 'Registered Address: '. $qc_dashboard_options['company_details']['registered_address_line1'] . '  ' . ( ! empty( $qc_dashboard_options['company_details']['registered_address_line2'] ) ? $qc_dashboard_options['company_details']['registered_address_line2'] . '  ' : '' ) . ( ! empty( $qc_dashboard_options['company_details']['registered_address_line3'] ) ? $qc_dashboard_options['company_details']['registered_address_line3'] . '  ' : '' ) . $qc_dashboard_options['company_details']['registered_address_city'] . '  ' . $qc_dashboard_options['company_details']['registered_address_location'] . '  ' . $qc_dashboard_options['company_details']['registered_address_postal_code'], 0, 1, 'C' );
