			...
			<div class="quote-calculator-sided select-wrapper">
				...
				<select name="quote_calculator_category[3][<?php echo $current_section_count; ?>][estimate_section_sided]">
					...
					<?php foreach( $impressions_array as $key => $impressions ) { ?>
						<option <?php echo isset( $current_estimate_section ) && $impressions['impressions_title'] == $current_estimate_section['estimate_section_sided'] ? 'selected="selected"' : ''; ?>><?php echo $impressions['impressions_title']; ?></option>
					<?php } ?>
				</select>
			</div>
		</div>
