...
class Clientside_Toolbar {
	...
	static function action_enqueue_site_toolbar_styles() {
		...
		if ( is_admin_bar_showing() && Clientside_Options::get_saved_option( 'enable-admin-theme' ) && Clientside_Options::get_saved_option( 'enable-site-toolbar-theme' ) ) {
			wp_enqueue_style( 'clientside-toolbar-css', plugins_url( 'css/clientside-site-toolbar-1.3.8.min.css', __FILE__ ) );
		}
	...
	static function action_add_toolbar_nodes_sooner( $wp_toolbar ) {
		...
		if ( is_admin() || Clientside_Options::get_saved_option( 'enable-site-toolbar-theme' ) ) {
			$wp_toolbar->add_node(
				array(
	...
	static function action_remove_toolbar_css_injection() {
		...
		if ( ! Clientside_Options::get_saved_option( 'enable-admin-theme' ) || ! Clientside_Options::get_saved_option( 'enable-site-toolbar-theme' ) ) {
			return;
		}
