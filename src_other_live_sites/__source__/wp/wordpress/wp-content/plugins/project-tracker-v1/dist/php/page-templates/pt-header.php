	...
	<body <?php body_class(); ?>>
		...
		<header id="header" class="header clear container" role="banner">
			...
			<div id="user" class="user">
				...
				?>
				<?php if ($first_name != '') { ?>
						<a href="<?php echo admin_url( 'admin.php?page=custom_dashboard', 'http' ); ?>">Howdy, <?php echo $first_name ?></a>
				<?php } else { ?>
						<a href="<?php echo admin_url( 'admin.php?page=custom_dashboard', 'http' ); ?>">Hey there!</a>
				<?php } ?>
			</div>
			...
			<nav id="nav" class="nav">
				<div class="navBarWrap">
					...
					<?php
						...
						$all_results = array( 'Design' => '', 'Print Production' => '', 'Jobs out' => '', 'Delivery' => '' );
						if ( get_option( 'qc_dashboard_department_options' ) ) {
							$qc_dashboard_department_options = get_option( 'qc_dashboard_department_options' );
						} else {
							$qc_dashboard_department_options = array( 'Design' => '', 'Print Production' => '', 'Jobs out' => '', 'Delivery' => '', 'Design Studio' => '' );
                        }
