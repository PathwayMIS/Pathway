	...
	<div class="wrapper">
		...
		<main role="main">
			...
			<section>
				...
				global $create_estimate_message, $create_estimate_error;
				...
				<form action="<?php the_permalink(); ?>" method="post">
					...
					<div class="quote-calculator-section last">
						...
						<div class="quote-calculator-section-content">
							...
							<?php } ?>							
							<textarea name="quote_calculator_delivery_notes" placeholder="<?php _e( 'Notes', 'quote_calculator' ); ?>"><?php echo ! empty( $current_estimate['estimates_notes'] ) ? $current_estimate['estimates_notes'] : ''; ?></textarea>
						</div>
						<div class="quote-calculator-section-title">
							<h3><?php _e( 'Memo', 'quote_calculator' ); ?></h3>
						</div>
						<div class="quote-calculator-section-content">
							<textarea name="quote_calculator_memo" placeholder="<?php _e( 'Memo', 'quote_calculator' ); ?>"><?php echo ! empty( $current_estimate['estimates_memo'] ) ? $current_estimate['estimates_memo'] : ''; ?></textarea>
						</div>
						<div class="quote-calculator-section-title">
						...
						<div class="quote-calculator-section-content last">
							...
							<?php } else { 
								if( isset( $_SESSION['accessToken'] ) ){ ?>
									<a href="<?php echo isset( $current_estimate ) ? '?quote_calculator_create_invoice=' . $current_estimate['estimates_id'] . '&_wp_nonce=' . wp_create_nonce( 'quote_calculator_create_invoice_action' ) : ''; ?>" <?php if( ! isset( $current_estimate ) ) echo 'class="disbaled"'; ?>><span class="button default right"><?php _e( 'Create Invoice', 'quote_calculator' ); ?></span></a>
								<?php } else { ?>
