				...
				foreach( $current_estimate_section['estimate_section_qty'] as $key => $estimate_section_qty ) { ?>
					<div class="quote-calculator-copy qty">
						<div class="quote-calculator-qty">
                            <input type="number" min="0" name="quote_calculator_category[3][<?php echo $current_section_count; ?>][estimate_section_qty][]" value="<?php echo !empty( $estimate_section_qty ) ? $estimate_section_qty : '0' ?>" data-qty="<?php echo $key; ?>" />
						</div>
