...
<div class="quote-calculator-section wide-format">
	<div class="quote-calculator-section-title">
		<h3><?php _e( 'Wide Format', 'quote_calculator' ); ?></h3>
	</div>
	<div class="quote-calculator-section-content">
		<div class="quote-calculator-subsection_title">
			<input name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_title]" value="<?php echo $current_estimate_section['estimate_section_title']; ?>" placeholder="Section Title" type="text" />
		</div>
		<div class="quote-calculator-subsection">
			...
			<div class="quote-calculator-type select-wrapper">
				<?php $product_type_array = quote_calculator_get_product_type( 4 ); ?>
				<select name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_type]">
			...
			<div class="quote-calculator-size select-wrapper">
				<?php $paper_size_array = quote_calculator_get_paper_size( 4 ); ?>
				<select name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_size]">
			...
			<div class="quote-calculator-sided select-wrapper">
				<?php $impressions_array = quote_calculator_get_impressions( 4 ); ?>
				<select name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_sided]">
		...
		<div class="quote-calculator-subsection">
			<?php if( isset( $current_estimate_section ) ) {
				...
				$quantity_array = quote_calculator_get_quantity( 4 );
				foreach( $current_estimate_section['estimate_section_qty'] as $key => $estimate_section_qty ) { ?>
					<div class="quote-calculator-copy qty">
						<div class="quote-calculator-qty">
                            <input type="number" min="0" name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_qty][]" value="<?php echo !empty( $estimate_section_qty ) ? $estimate_section_qty : '0' ?>" data-qty="<?php echo $key; ?>" />
						</div>
				...
				<div class="quote-calculator-copy qty">
					<div class="quote-calculator-qty">
                        <input type="number" min="0" name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_qty][]" value="<?php echo !empty( $current_estimate_section['estimate_section_qty'] ) ? $current_estimate_section['estimate_section_qty'] : '0' ?>" data-qty="0" />
					</div>
					<div class="quote-calculator-remove remove-qty"><span class="dashicons dashicons-no"></span></div>
				</div>
			<?php } ?>
		...
		<div class="quote-calculator-subsection">
			...
			<?php $colour_array = quote_calculator_get_colour( 4 );
			foreach( $colour_array as $key => $colour ) { ?>
				<label data-for="quote_calculator_colour_4_<?php echo $key; ?>"><input type="radio" data-calculation="<?php echo $colour['colour_price']; ?>" name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_color]" value="<?php echo $colour['colour_title']; ?>" id="quote_calculator_colour_4_<?php echo $key; ?>" <?php echo isset( $current_estimate_section ) && $colour['colour_title'] == $current_estimate_section['estimate_section_color'] ? 'checked="checked"' : ''; ?> /><span class="quote-calculator-colour"><?php echo $colour['colour_title']; ?></span></label>
			<?php } ?>
		</div>
		<div class="quote-calculator-subsection">
			<div class="quote-calculator-subsection-title">
			...
			<div class="quote-calculator-qty select-wrapper">
				<?php $page_count_array = quote_calculator_get_page_count( 4 ); ?>
				<select name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_page_count]">
		...
		<div class="quote-calculator-subsection">
			...
			<div class="quote-calculator-qty select-wrapper">
				<select name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_orientation]">
		...
		<div class="quote-calculator-subsection">
			...
			<?php $paper_array = quote_calculator_get_paper( 4 ); 
			$paper_name_array = $paper_weigth_array = $paper_format_array = array();
			foreach( $paper_array as $paper ) {
				...
				if( ! empty( $paper['paper_format'] ) ){
					if( ! isset( $paper_format_array[ $paper['paper_format'] ] ) ){
						$paper_format_array[ $paper['paper_format'] ] = $paper['paper_title'];
					}
					else {
						if( false === strpos( $paper['paper_title'], $paper_format_array[ $paper['paper_format'] ] ) ) {
							$paper_format_array[ $paper['paper_format'] ] .= ' ' . $paper['paper_title'];
						}
					}
				}
				...
				<?php } else { ?>
					<input type="hidden" class="paper-calculation" data-type="<?php echo $paper['paper_title']; ?>-<?php echo $paper['paper_format']; ?>" value="<?php echo $paper['paper_price']; ?>" />
				<?php }
			}
			echo '<input type="hidden" class="paper-calculation" data-type="-" value="0" />';
			ksort( $paper_weigth_array, SORT_NUMERIC );
			ksort( $paper_format_array );
			if( ! empty( $current_estimate_section ) ) {
				...
				foreach( $current_estimate_section['estimate_section_weight'] as $section_key => $estimate_section_weight ) { ?>
					<div class="quote-calculator-copy paper">
						<div class="quote-calculator-cover select-wrapper">
							<select name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_cover][]">
						...
						<div class="quote-calculator-type select-wrapper">
							<select name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_paper_type][]">
						...
						<div class="quote-calculator-weight select-wrapper">
							<select name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_weight][]">
		...
		<div class="quote-calculator-subsection">
			...
			<?php $finishing_array = quote_calculator_get_finishing( 4 );
				...
				foreach( $current_estimate_section['estimate_section_finishing'] as $section_key => $estimate_section_finishing ){ ?>
					<div class="quote-calculator-copy finishing">
						<div class="quote-calculator-finishing-type select-wrapper">
							<select name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_finishing][]">
		...
		<div class="quote-calculator-subsection">
			...
			<label>
				<span><?php _e( 'Overhead %', 'quote_calculator' ); ?></span><input type="number" min="0" name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_overhead]" value="<?php echo isset( $current_estimate_section['estimate_section_overhead'] ) ? $current_estimate_section['estimate_section_overhead'] : $quote_calculator_options['overhead']; ?>" />
			</label>
			<label>
				<span><?php _e( 'Profit Margin %', 'quote_calculator' ); ?></span><input type="number" min="0" name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_profit]" value="<?php echo isset( $current_estimate_section['estimate_section_profit'] ) ? $current_estimate_section['estimate_section_profit'] : $quote_calculator_options['profit']; ?>" />
			</label>
			<label>
				<span><?php _e( 'VAT %', 'quote_calculator' ); ?></span><input type="number" min="0" name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_vat]" value="<?php echo isset( $current_estimate_section['estimate_section_vat'] ) ? $current_estimate_section['estimate_section_vat'] : $quote_calculator_options['vat']; ?>" />
			</label>
		</div>
		<div class="quote-calculator-subsection">
			<div class="quote-calculator-subsection-title">
			...
			<?php if( isset( $current_estimate_section ) ){
				...
				foreach( $current_estimate_section['estimate_section_cost'] as $key => $estimate_section_cost ){ ?>
					<div class="quote-calculator-copy display-cost" data-qty="<?php echo $key; ?>">
						...
						<input type="hidden" name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_cost][]" value="<?php echo $estimate_section_cost; ?>" />
						<input type="hidden" name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_cost_without_vat][]" value="<?php echo $current_estimate_section['estimate_section_cost_without_vat'][ $key ]; ?>" />
					</div>
				<?php }
			} else { ?>
				<div class="quote-calculator-copy display-cost" data-qty="0">
					...
					<input type="hidden" name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_cost][]" value="<?php echo '0'; ?>" />
					<input type="hidden" name="quote_calculator_category[4][<?php echo $current_section_count; ?>][estimate_section_cost_without_vat][]" value="<?php echo '0'; ?>" />
				</div>
			<?php } ?>
		</div>
		<div class="quote-calculator-subsection">
