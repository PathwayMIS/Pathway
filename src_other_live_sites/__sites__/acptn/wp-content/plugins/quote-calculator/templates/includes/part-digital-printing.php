		...
		<div class="quote-calculator-subsection">
			<?php if( isset( $current_estimate_section ) ) {  
				...
				foreach( $current_estimate_section['estimate_section_qty'] as $key => $estimate_section_qty ) { ?>
					<div class="quote-calculator-copy qty">
                        <div class="quote-calculator-qty">
							<input type="number" min="0" name="quote_calculator_category[1][<?php echo $current_section_count; ?>][estimate_section_qty][]" value="<?php echo !empty( $estimate_section_qty ) ? $estimate_section_qty : '0' ?>" data-qty="<?php echo $key; ?>" />
						</div>
				...
				<div class="quote-calculator-copy qty">
					<div class="quote-calculator-qty">
						<div class="quote-calculator-qty">
                            <input type="number" min="0" name="quote_calculator_category[1][<?php echo $current_section_count; ?>][estimate_section_qty][]" value="<?php echo !empty( $current_estimate_section['estimate_section_qty'] ) ? $current_estimate_section['estimate_section_qty'] : '0' ?>" data-qty="0" />
                        </div>
					</div>
					<div class="quote-calculator-remove remove-qty"><span class="dashicons dashicons-no"></span></div>
				</div>
