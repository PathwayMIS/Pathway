...
define('DB_NAME', 'pathway-ek-u-183556');

/** MySQL database username */
define('DB_USER', 'pathway-sdzzrl');

/** MySQL database password */
define('DB_PASSWORD', '14&0cXkh');
 ...
 */
if( $_SERVER['HTTP_HOST'] == 'qc.pathwaymis.co.uk' ){
		/*define('WP_DEBUG', true);
		ini_set('error_reporting', E_ALL);
		ini_set('display_errors', 1);
		define( 'WP_DEBUG_LOG', true );*/
}
else if( $_SERVER['HTTP_HOST'] == 'acp.pathwaymis.co.uk' ){
		/*define('WP_DEBUG', true);
		ini_set('error_reporting', E_ALL);
		ini_set('display_errors', 1);
		define( 'WP_DEBUG_LOG', true );*/
...
define('DOMAIN_CURRENT_SITE', 'pathwaymis.co.uk'); //absolutecp.co.uk
