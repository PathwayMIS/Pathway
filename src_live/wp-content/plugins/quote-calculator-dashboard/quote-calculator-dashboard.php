...
class QS_Dashboard {
			...
			<div class="qc-dashboard-wrap">
				<div class="qc-dashboard-block-left">
					<div class="qc-dashboard-workflow">
						...
						<div>
							...
							<div class="qc-dashboard-workflow-content">
								<div class="qc-dashboard-workflow-number"><?php echo count( $wideformat_count ); ?></div>
								<div class="qc-dashboard-workflow-label"><?php _e( 'Wideformat', 'qc_dashboard' ); ?></div>
							</div>
							<div class="qc-dashboard-workflow-content">
				...
				<div class="qc-dashboard-block-right">
					<div class="qc-dashboard-jobs">
						<div class="qc-dashboard-block-title"><?php _e( 'Jobs in Progress', 'qc_dashboard' ); ?></div>
						<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.3/Chart.min.js"></script>
						<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.3/Chart.min.css" />
						<div class="qc-dashboard-jobs-canvas">
							<canvas id="qcJobChart" width="400" height="400"></canvas>
						</div>
						<script>
	...
	function edit_dashboard(){
		...
		if( isset( $_POST['qc_save_colour_options'] ) && wp_verify_nonce( $_POST['qc_save_colour_options'], 'savecolour' ) ) {
		 	$this->qc_dashboard_options['dashboard_details'] = array(
					...
					<div class="qc_edit_dashboard_logo" id="qc_edit_dashboard_logo">
						<?php if( isset( $this->qc_dashboard_options['dashboard_details']['logo'] ) && '' !== $this->qc_dashboard_options['dashboard_details']['logo'] ) {
							$url = $this->qc_dashboard_options['dashboard_details']['logo'];
								...
								$url = plugins_url( 'images/admin_logo.png', __FILE__ );
						} ?>
	...
	function edit_departments(){
		...
		if( isset( $_POST['qc_edit_departments'] ) && wp_verify_nonce( $_POST['qc_edit_departments'], 'qc_edit_departments' ) ) {
			...
			$qc_dashboard_department_options[ 'Wideformat' ] = '';
			var_dump($qc_dashboard_department_options);
		...
		$all_values = array( 'Design', 'Print Production', 'Wideformat', 'Jobs out', 'Delivery' );
	...
	function colour_coding(){
		...
		<div class="wrap">
			...
			<form method="post" action="<?php echo admin_url( 'admin.php?page=colour_coding' ); ?>">
				...
				<div class="qc_color_coding_block">
					<label><?php _e( 'Wideformat', 'qc_dashboard'); ?></label>
					<input type="text" class="color-field-print" value="<?php echo $this->qc_dashboard_options['calendar_color_options']['wideformat']; ?>" name="qc_colour_wideformat" />
					<div class="clear"></div>
				</div>
				<div class="qc_color_coding_block">
	...
	function in_admin_header(){
		global $current_user;
		$logo_url = '' !== $this->qc_dashboard_options['dashboard_details']['logo'] ? $this->qc_dashboard_options['dashboard_details']['logo'] : plugins_url( 'images/admin_logo.png', __FILE__ ); ?>
