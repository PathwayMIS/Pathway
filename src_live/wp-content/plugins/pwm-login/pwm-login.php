...
class PWM_Login {
	...
	public function login_enqueue_scripts() {
		...
		wp_enqueue_script( 'pwm_login_script', plugins_url( 'js/script.js', __FILE__ ), array( 'jquery' ), $this->plugin_info['Version'], true );
	}
	...
	public function login_footer() { ?>
			...
			<div class="pwm-login-footer">
				...
				<ul class="pwm-login-footer-menu">
					<li>
						<a href="https://www.pathwaymis.co.uk/contact"><?php _e( 'Contact', 'pwm-sites' ); ?></a>
					</li>
					<li>
						<a href="https://www.pathwaymis.co.uk/terms-conditions"><?php _e( 'Terms & Conditions', 'pwm-sites' ); ?></a>
					</li>
					<li>
						<a href="https://www.pathwaymis.co.uk/privacy-policy"><?php _e( 'Privacy Policy', 'pwm-sites' ); ?></a>
					</li>
					<li>
						<a href="https://www.pathwaymis.co.uk/cookie-policy"><?php _e( 'Cookie Policy', 'pwm-sites' ); ?></a>
					</li>
				</ul>
			</div>
		</div>
	...
	public function login_form() { ?>
		<p class="pwm-forgot-password"><a href="<?php echo esc_url( site_url() . '/wp-login.php?action=lostpassword' ); ?>"><?php _e( 'Forgot Password?', 'pwm-sites' ); ?></a></p>
	<?php }
