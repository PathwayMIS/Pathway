...
function insert_my_page_template( $template )
{
    ...
    } elseif ( is_page('project-tracker-proof' ) ) {
        return plugin_dir_path( __FILE__ ) . 'dist/php/page-templates/page-project-tracker-proof.php';
    ...
    } elseif ( is_page('project-tracker-wideformat' ) ) {
        return plugin_dir_path( __FILE__ ) . 'dist/php/page-templates/page-project-tracker-wideformat.php';
...
function dmk_redirect_to_login_if_not_logged_in() {
    ...
    if ( ! is_user_logged_in() && ! strstr( $_SERVER['REQUEST_URI'], 'signup' ) ) {
