...
add_action( 'init', array( 'Clientside', 'dequeue_jquery' ) );
add_action( 'wp_default_scripts', array( 'Clientside', 'dequeue_jquery_migrate' ) );
add_action( 'init', array( 'Clientside', 'dequeue_embed_script' ) );
//add_action( 'init', array( 'Clientside', 'action_add_custom_add_new_buttons' ) );
