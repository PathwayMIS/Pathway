...
<main role="main">
	...
	<section class="app__table">
		<div class="app__table__headings__container">
			...
			<h6 class="app__table__heading app__table__heading--stage">EC</h6>
			<h6 class="app__table__heading app__table__heading--stage">LH</h6>
			<h6 class="app__table__heading app__table__heading--stage">JY</h6>
		</div>
